...
func getNetConfig(net string) *Config {
	...
	if net == "main" {
		...
		cfg.Forwarder.Gateways.ThingsIXOnboardEndpoint = "https://api.thingsix.com/gateways/v1/onboards/{owner}"
	...
	if net == "test" {
		...
		cfg.Forwarder.Gateways.ThingsIXOnboardEndpoint = "https://api-testnet.thingsix.com/gateways/v1/onboards/{owner}"
	...
	if net == "dev" {
		...
		cfg.Forwarder.Gateways.ThingsIXOnboardEndpoint = "https://api-devnet.thingsix.com/gateways/v1/onboards/{owner}"
